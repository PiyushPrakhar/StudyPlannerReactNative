...
public class BillingManager implements PurchasesUpdatedListener {
     ...
     */
    private static final String BASE_64_ENCODED_PUBLIC_KEY = "";
    ...
    public BillingManager(Activity activity, final BillingUpdatesListener updatesListener) {
        ...
        startServiceConnection(new Runnable() {
            ...
            public void run() {
                ...
                Log.d(TAG, "Setup successful. Querying inventory, Billing manager");
                queryPurchases();
            }
        });
    }
    ...
    public void queryPurchases() {
        Runnable queryToExecute = new Runnable() {
            ...
            public void run() {
                ...
                spe.putBoolean(BillingConstants.SKU_LINEAR_TRACKING,false);
                spe.putBoolean(BillingConstants.SKU_PLANNER_AI,false);
                spe.putBoolean(BillingConstants.SKU_SOOTHING_MUSIC,false);
                spe.apply();

                for( int i =0 ;i<purchasesResult.getPurchasesList().size();i++)
                {
                    String skuTemp = purchasesResult.getPurchasesList().get(i).getSku();
                    if(skuTemp.equals(BillingConstants.SKU_LINEAR_TRACKING))
                        spe.putBoolean(BillingConstants.SKU_LINEAR_TRACKING,true);

                    if(skuTemp.equals(BillingConstants.SKU_PLANNER_AI))
                        spe.putBoolean(BillingConstants.SKU_PLANNER_AI,true);

                    if(skuTemp.equals(BillingConstants.SKU_SOOTHING_MUSIC))
